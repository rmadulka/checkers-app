...
public class PostPreviousTurnRouteTest {
    ...
    public void setup() {
        ...
        CuT = new PostPreviousTurnRoute(playerLobby);
    }

    /**
     * Tests when the previous button should be enabled
     */
    @Test
    public void valid_previous_turn(){
    ...
    /**
     * Tests when the previous button should be disabled
     */
    @Test
